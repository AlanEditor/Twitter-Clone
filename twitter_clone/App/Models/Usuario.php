...
class Usuario extends Model {
	...
	function getAll()
	{
		...
		$smtm->bindValue(':id_usuario', $this->__get('id'));
		$smtm->execute();

		return $smtm->fetchAll(\PDO::FETCH_ASSOC);
	}

	function seguirUsuario($id_usuario_seguindo)
	{
	...
	function deixarSeguirUsuario($id_usuario_seguindo)
	{
